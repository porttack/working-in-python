...
vocab-by-chapter: ; python3 tools/build_vocabulary_by_chapter.py
...
.PHONY: projector ledger glossary vocab-by-chapter check session jupyterlite jupyterlite-serve
