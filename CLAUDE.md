...
| 4. Chapter chrome | `mods/pass-4-chrome.md` | destructive edits (front/back matter only — link bar, embedded pane, exercises notebook, attribution rule) | in progress — ch. 1–2 done, built up across several rounds of live testing against the deployed site; ch. 3–6 done 2026-08-09, matched the pattern exactly; ch. 7–11 pending; ch. 12–19 out of scope (independent-study/post-exam tier gets none of this). See `AUDIT.md` |
